export const scrapItems = [
  ...
  { name: "Copies/books", rate: "₹12/kg", category: "normal", note: "Books and notebooks for paper recovery.", icon: "BookOpen" },
  ...
  { name: "Steel", rate: "₹40/kg", category: "normal", note: "Utensils, frames and small steel scrap.", icon: "HardHat" },
  { name: "Aluminium", rate: "₹105/kg", category: "normal", note: "Cans, frames and clean aluminium scrap.", icon: "PackageOpen" },
  ...
  { name: "Washing machine", rate: "Quote", category: "appliance", note: "Schedule inspection for pickup value.", icon: "WashingMachine" },
